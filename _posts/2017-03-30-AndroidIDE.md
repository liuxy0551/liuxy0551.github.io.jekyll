...
* [工具 / 原料](#工具 / 原料)
* [方法 / 步骤](#方法 / 步骤)
    * [JDK的安装与环境变量的配置](#一、JDK的安装与环境变量的配置)
    * [下载安装Eclipse](### 二、下载安装Eclipse)
    * [下载安装Android SDK](### 三、下载安装Android SDK)
        * [下载](#### 1、下载)
        * [安装](#### 2、安装)
            * [更改host文件](#### (1).更改host文件)
            * [将SDK Manage上的https请求更改成http请求](#### (2).将SDK Manage上的https请求更改成http请求)
            * [下载](#### 1、下载)
* [图片](#图片)
    * 来源于网络的图片
    * GitHub仓库中的图片
