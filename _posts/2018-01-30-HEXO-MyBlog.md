...
---   
    ...
    我的博客是我在原作者教程的指导下，使用自己的方法构建的，可能有部分还没发现的问题，欢迎指正，晚些时候我会写一篇自己博客构建的过程，本篇博客是原作者的部分重要内容。

　　经过各种找资料，踩过各种坑，终于使用 Atom + Github Desktop 搭建个人博客初步完成了，域名目前用得时 github 的，我使用的软件是 Atom + Github Desktop。
